...
const SAMPLE_APPLICATIONS = [
  {
    ...
    status: "pending",
    skills: ["Education & Tutoring", "Language Support"],
  ...
  },
  {
    ...
    experience: "Fluent in Arabic, English, and French"
  },
  {
    id: 4,
    name: "Sarah Johnson",
    ...
    experience: "3 years marketing experience"
  }
];
...
const VolunteerApplications = () => {
  ...
  const handleOpenEmailDialog = (application) => {
    setSelectedApplication(application);
    setEmailContent({
      subject: `Your Volunteer Application with Refugee Network Centre`,
      message: `Dear ${application.name},\n\nThank you for your interest in volunteering with the Refugee Network Centre.\n\n[Your message here]\n\nBest regards,\nThe RNC Team`
    });
  ...
  const handleSendEmail = async () => {
    try {
      ...
      setSuccessMessage(`Email sent to ${selectedApplication.name}`);
  ...
  return (
    <Box>
        ...
        <DialogContent>
          {selectedApplication && (
            <Box>
              ...
              <Box sx={{ mb: 2 }}>
                <Typography variant="h6" gutterBottom>Skills & Availability</Typography>
                ...
                <Typography><strong>Availability:</strong> {selectedApplication.availability}</Typography>
              </Box>
      ...
      <Dialog open={confirmDeleteOpen} onClose={handleCloseDeleteDialog}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete the application from &quot;{applicationToDelete?.name}&quot;? This action cannot be undone.
          </Typography>
        </DialogContent>
        <DialogActions>
